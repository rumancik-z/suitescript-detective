...
import { NETSUITE_HOST_RE, ACCOUNT_ID_RE } from "./constants.js";

/**
 * Extract account info from a URL string, or null if it is not a NetSuite tab.
 * @param {string} urlString
 * @returns {AccountInfo | null} Null for non-account hosts (e.g. login.netsuite.com).
 */
export const parseAccountFromUrl = (urlString) => {
  ...
  if (!idMatch) return null; // non-account host (e.g. login.netsuite.com)
